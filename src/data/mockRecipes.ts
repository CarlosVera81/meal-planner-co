...
export const mockRecipes: Recipe[] = [
  {
    ...
    servingsBase: 4, // Base original
    originalServingsBase: 4, // Guardamos para regla de 3
    servings: 4,
    timeMin: 45,
    difficulty: 'Medio',
  ...
  // Desayunos
  {
    ...
    ingredients: [
      { id: '6-1', name: 'Huevos', quantity: 6, unit: 'unidades', category: 'Lácteos/Huevos', pricePerUnit: 300, allergens: ['huevo'] },
      { id: '6-2', name: 'Espinaca fresca', quantity: 100, unit: 'g', category: 'Verdulería', pricePerUnit: 400 },
      { id: '6-3', name: 'Queso rallado', quantity: 60, unit: 'g', category: 'Lácteos/Huevos', pricePerUnit: 1000, allergens: ['lactosa'] }
    ],
  ...
  },
  {
    ...
    imageUrl: avenaImage,
    ingredients: [
      { id: '7-1', name: 'Avena', quantity: 160, unit: 'g', category: 'Abarrotes/Granos', pricePerUnit: 600, allergens: ['gluten'] },
      { id: '7-2', name: 'Leche', quantity: 400, unit: 'ml', category: 'Lácteos/Huevos', pricePerUnit: 1000, allergens: ['lactosa'] },
      { id: '7-3', name: 'Frutas mixtas', quantity: 300, unit: 'g', category: 'Frutas', pricePerUnit: 1200 }
    ],
  ...
  },
  {
    ...
    imageUrl: paltaImage,
    ingredients: [
      { id: '8-1', name: 'Pan integral', quantity: 4, unit: 'rebanadas', category: 'Abarrotes/Granos', pricePerUnit: 500, allergens: ['gluten'] },
      { id: '8-2', name: 'Palta', quantity: 2, unit: 'unidad', category: 'Frutas', pricePerUnit: 800 }
    ],
  ...
  // Almuerzos
  {
    ...
    ingredients: [
      { id: '9-1', name: 'Láminas de lasaña', quantity: 167, unit: 'g', category: 'Abarrotes/Granos', pricePerUnit: 1500, allergens: ['gluten'] },
      { id: '9-2', name: 'Berenjena', quantity: 0.67, unit: 'unidad', category: 'Verdulería', pricePerUnit: 700 },
      { id: '9-3', name: 'Queso mozzarella', quantity: 133, unit: 'g', category: 'Lácteos/Huevos', pricePerUnit: 2500, allergens: ['lactosa'] }
    ],
  ...
  },
  {
    ...
    ingredients: [
      { id: '13-1', name: 'Filete de salmón', quantity: 4, unit: 'unidades', category: 'Pescados', pricePerUnit: 5000 },
      { id: '13-2', name: 'Limón', quantity: 2, unit: 'unidad', category: 'Frutas', pricePerUnit: 200 }
    ],
  ...
  },
  {
    ...
    imageUrl: cesarImage,
    ingredients: [
      { id: '14-1', name: 'Lechuga romana', quantity: 1.33, unit: 'unidad', category: 'Verdulería', pricePerUnit: 900 },
      { id: '14-2', name: 'Crutones', quantity: 67, unit: 'g', category: 'Abarrotes/Granos', pricePerUnit: 600, allergens: ['gluten'] },
      { id: '14-3', name: 'Queso parmesano', quantity: 53, unit: 'g', category: 'Lácteos/Huevos', pricePerUnit: 1800, allergens: ['lactosa'] }
    ],
  ...
  // Snacks
  {
    ...
    ingredients: [
      { id: '15-1', name: 'Frutas variadas', quantity: 400, unit: 'g', category: 'Frutas', pricePerUnit: 1200 },
      { id: '15-2', name: 'Yogurt natural', quantity: 300, unit: 'ml', category: 'Lácteos/Huevos', pricePerUnit: 900, allergens: ['lactosa'] }
    ],
  ...
  },
  {
    ...
    ingredients: [
      { id: '17-1', name: 'Yogurt natural', quantity: 600, unit: 'ml', category: 'Lácteos/Huevos', pricePerUnit: 1000, allergens: ['lactosa'] },
      { id: '17-2', name: 'Granola', quantity: 160, unit: 'g', category: 'Abarrotes/Granos', pricePerUnit: 1200, allergens: ['gluten'] }
    ],
  ...
  },
  {
    ...
    ingredients: [
      { id: '18-1', name: 'Pan de molde', quantity: 8, unit: 'rebanadas', category: 'Abarrotes/Granos', pricePerUnit: 500, allergens: ['gluten'] },
      { id: '18-2', name: 'Jamón', quantity: 4, unit: 'rebanada', category: 'Carnes', pricePerUnit: 600 },
      { id: '18-3', name: 'Queso', quantity: 4, unit: 'rebanada', category: 'Lácteos/Huevos', pricePerUnit: 700, allergens: ['lactosa'] }
    ],
  ...
  },
  {
    ...
    ingredients: [
      { id: '19-1', name: 'Frutas de temporada', quantity: 600, unit: 'g', category: 'Frutas', pricePerUnit: 1500 }
    ],
...
export const recipesNormalized = normalizeRecipes(mockRecipes);
